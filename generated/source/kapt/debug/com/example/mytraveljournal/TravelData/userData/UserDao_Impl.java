...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `User` (`name`,`password`,`id`) VALUES (?,?,nullif(?, 0))";
      }
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `User` SET `name` = ?,`password` = ?,`id` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object loginUser(final String name, final String password,
      final Continuation<? super User> $completion) {
    final String _sql = "SELECT * FROM user WHERE name = ? AND password = ?";
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpName,_tmpPassword,_tmpId);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<User> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final int _tmpId;
            _tmpId = _cursor.getInt(_cursorIndexOfId);
            _item = new User(_tmpName,_tmpPassword,_tmpId);
            _result.add(_item);
          }
          return _result;
        } finally {
